...
Feature: Purchase: One Product
  ...
  Scenario Outline: Purchase '<product>' product
    ...
    Scenarios:
      ...
      | Sauce Labs Onesie                 | sRib snap infant onesie for the junior automation engineer in development. Reinforced 3-snap bottom closure, two-needle hemmed sleeved and bottom won't unravel.        | 7.99  | 0.64 | 8.63  |
